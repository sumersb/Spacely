...
export default function UserCreateForm(props) {
  ...
  const resetStateValues = () => {
    setLegalFirstName(initialValues.legalFirstName);
    setEmail(initialValues.email);
    setSearchingForRoommate(initialValues.searchingForRoommate);
    setBio(initialValues.bio);
    setPrfilePic(initialValues.prfilePic);
    setPosting(initialValues.posting);
    setSocials(initialValues.socials);
    setDateCreated(initialValues.dateCreated);
    setPhone(initialValues.phone);
    setSaveLists(initialValues.saveLists);
    setProfile(initialValues.profile);
    setTimeCreated(initialValues.timeCreated);
    setLegalLastName(initialValues.legalLastName);
    setSearchingForRoommate1(initialValues.SearchingForRoommate);
    setSocials1(initialValues.Socials);
    setProfile1(initialValues.Profile);
    setUserSearchingForRoommateId(initialValues.userSearchingForRoommateId);
    setUserSocialsId(initialValues.userSocialsId);
