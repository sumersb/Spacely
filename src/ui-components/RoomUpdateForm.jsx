...
export default function RoomUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = { ...initialValues, ...roomRecord };
    setRoomNum(cleanValues.roomNum);
    setRoomDetails(cleanValues.roomDetails);
    setErrors({});
  };
  const [roomRecord, setRoomRecord] = React.useState(room);
  React.useEffect(() => {
    const queryData = async () => {
      const record = id ? await DataStore.query(Room, id) : room;
