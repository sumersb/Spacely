...
export default function ContentsUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = { ...initialValues, ...contentsRecord };
    setGym(cleanValues.gym);
    setParking(cleanValues.parking);
    setHousingType(cleanValues.housingType);
    setPets(cleanValues.pets);
    setAc(cleanValues.ac);
    setHeater(cleanValues.heater);
    setLaundry(cleanValues.laundry);
    setFurnishing(cleanValues.furnishing);
    setGym1(cleanValues.Gym);
    setParking1(cleanValues.Parking);
    setHousingType1(cleanValues.HousingType);
    setPet(cleanValues.Pet);
    setLaundry1(cleanValues.Laundry);
    setFurnishing1(cleanValues.Furnishing);
    setContentsGymId(cleanValues.contentsGymId);
    setContentsParkingId(cleanValues.contentsParkingId);
    setContentsHousingTypeId(cleanValues.contentsHousingTypeId);
    setContentsPetId(cleanValues.contentsPetId);
    setContentsLaundryId(cleanValues.contentsLaundryId);
    setContentsFurnishingId(cleanValues.contentsFurnishingId);
    setErrors({});
  };
  const [contentsRecord, setContentsRecord] = React.useState(contents);
  React.useEffect(() => {
    const queryData = async () => {
      const record = id ? await DataStore.query(Contents, id) : contents;
  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        isRequired={false}
        isReadOnly={false}
        defaultValue={contentsParkingId}
        onChange={(e) => {
          let { value } = e.target;
          if (onChange) {
            const modelFields = {
      ...
      <TextField
        ...
        isRequired={false}
        isReadOnly={false}
        defaultValue={contentsHousingTypeId}
        onChange={(e) => {
          let { value } = e.target;
          if (onChange) {
            const modelFields = {
      ...
      <TextField
        ...
        isRequired={false}
        isReadOnly={false}
        defaultValue={contentsLaundryId}
        onChange={(e) => {
          let { value } = e.target;
          if (onChange) {
            const modelFields = {
      ...
      <TextField
        ...
        isRequired={false}
        isReadOnly={false}
        defaultValue={contentsFurnishingId}
        onChange={(e) => {
          let { value } = e.target;
          if (onChange) {
            const modelFields = {
