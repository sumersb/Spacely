...
export default function PostingImagesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const [mainImages, setMainImages] = React.useState(initialValues.mainImages);
  const [errors, setErrors] = React.useState({});
  const resetStateValues = () => {
    setImages(initialValues.images);
    setCurrentImagesValue(undefined);
    setMainImages(initialValues.mainImages);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          mainImages: mainImages || undefined,
        };
        ...
        try {
          await DataStore.save(new PostingImages(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, "PostingImagesCreateForm")}
    >
      <ArrayField
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.mainImages ?? value;
          }
          if (errors.mainImages?.hasError) {
            runValidationTasks("mainImages", value);
          }
          setMainImages(value);
        }}
        onBlur={() => runValidationTasks("mainImages", mainImages)}
        errorMessage={errors.mainImages?.errorMessage}
        hasError={errors.mainImages?.hasError}
        {...getOverrideProps(overrides, "mainImages")}
      ></TextField>
      <Flex
